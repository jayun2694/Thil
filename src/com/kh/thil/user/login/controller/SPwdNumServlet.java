...
/**
 * Servlet implementation class SPwdNumServlet
 */
@WebServlet("/sPwdNum.me")
public class SPwdNumServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */ 
    public SPwdNumServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String userId = request.getParameter("userId");
         ...
         String password = ""; //"ggggg";//자신의 네이버 패스워드
         ...
         try {
             ...
             msg.setFrom(new InternetAddress(user, "내가 사는 그 집"));
             msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to_email));
             
             //메일 제목
             msg.setSubject("안녕하세요 내가 사는 그 집 인증 메일입니다.");
             //메일 내용
